...
#     type: single_value
#     explore: orders
#     measures: [order_facts.average_order_profit]
#     listen:
#       date: orders.created_date
#       state: users.state
#     font_size: medium
...
#     type: single_value
#     explore: orders
#     measures: [order_facts.first_purchase_count]
#     listen:
#       date: orders.created_date
#       state: users.state
#     font_size: medium
...
#     model: thelook
#     explore: order_items
#     dimensions: [products.id, products.category, products.brand, products.item_name, products.product_image,
